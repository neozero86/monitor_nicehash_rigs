...
def main():
	...
	Reporter.instance().init(email_sender, {"interval_seconds":86400, "production": True}, logger)
	monitor = Monitor(logger, api_adapter, email_sender, rigs, devices, conf.error_threshold, conf.max_rejected_ratio, conf.polling_interval_sec)
	monitor.run()
