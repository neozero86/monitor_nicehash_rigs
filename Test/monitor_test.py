...
class MonitorTest(unittest.TestCase):
    ...
    emails_sended = ["Daily Report\n================\n\nErrors:\n{   'name_accepted_speed_0': {[name_accepted_speed_0] speedAccepted = 0: 2},\n    'name_empty': {[name_empty] host is down: 2},\n    'name_fan_speed_low': {   [name_fan_speed_low.GeForce RTX 3090.0] current fan speed: 4.0 lower than min fan speed 10.0: 2},\n    'name_invalid_profile': {   [name_invalid_profile.device [Invalid_card] not recognized] device not recognized, check DEVICES variable in conf.json: 2},\n    'name_low_hash_rate_id_2': {   [name_low_hash_rate_id_2.GeForce RTX 3060.2] current core temp: -1.0 lower than min core temp 0: 2,\n                                   [name_low_hash_rate_id_2.GeForce RTX 3060.2] current hash rate: 25.22 lower than min hash rate 43.0: 2,\n                                   [name_low_hash_rate_id_2.GeForce RTX 3060.2] no vram metric: 2},\n    'name_not_active': {[name_not_active] host is down: 2},\n    'name_power_high': {   [name_power_high] has only 1 devices. The expected amount is 2: 2,\n                           [name_power_high.GeForce RTX 3090.0] current power: 400.0 exceed max power 350.0: 2},\n    'name_rejected_ratio_high': {   [name_rejected_ratio_high] rejected_ratio = 50.0%: 2}}\n\nProblems:\n{}\n\nSolutions:\n{}\n\nAmount of errors:\n{   'name_accepted_speed_0': 2,\n    'name_empty': 2,\n    'name_fan_speed_low': 2,\n    'name_invalid_profile': 2,\n    'name_low_hash_rate_id_2': 2,\n    'name_not_active': 2,\n    'name_power_high': 2,\n    'name_rejected_ratio_high': 2}\n"]
