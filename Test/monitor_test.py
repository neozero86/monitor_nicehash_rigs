...
class MonitorTest(unittest.TestCase):
    ...
    expected_error_set = set([
        ...
        'Rig: id_invalid_profile; Script error [device [Invalid_card] not recognized]',
        '[id_low_hash_rate_id_2.GeForce RTX 3060.2] current hash rate: 25.22 lower than min hash rate 43.0.',
        '[id_low_hash_rate_id_2.GeForce RTX 3060.2] current core temp: -1.0 lower than min core temp 0.',
        '[id_low_hash_rate_id_2.GeForce RTX 3060.2] no vram metric',
        '[id_power_high.GeForce RTX 3090.0] current power: 400.0 exceed max power 350.0.',
