...
class private_api:
    ...
    def get_my_rig_stats(self, rig_id):
        return self.request('GET', '/main/api/v2/mining/algo/stats', 'rigId=' + rig_id, None)

    def get_my_rig_details(self, rig_id):
        return self.request('GET', '/main/api/v2/mining/rig2/'+ rig_id,'', None) #temp  % 65536


#GET  RIG STATISTICS 
#GET /main/api/v2/mining/groups/list GROUPS 
#GET /main/api/v2/mining/miningAddress MiningAddress 
#GET /main/api/v2/mining/rig/stats/algo RIG STATISTICS 
#GET /main/api/v2/mining/rig/stats/unpaid RIG STATISTICS 
#GET /main/api/v2/mining/rig2/{rigId} RIG DETAILS 
#GET /main/api/v2/mining/rigs/activeWorkers ACTIVE WORKERS 
#GET /main/api/v2/mining/rigs/payouts PAYOUTS 
#GET /main/api/v2/mining/rigs/stats/algo MINER STATISTICS 
#GET /main/api/v2/mining/rigs/stats/unpaid MINER STATISTICS 
#POST /main/api/v2/mining/rigs/status2 RIG ACTION 
#GET /main/api/v2/mining/rigs2 RIGS 
